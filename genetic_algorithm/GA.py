...
def genetic_Algorithm(mutation_rate_rows, mutation_rate_init, cross_rate, cross_rate_rows, tournament_size, elite_size, popsize, max_gens, given_matrix, function=total_error):
